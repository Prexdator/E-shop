...
?>
 ...
 while($row = mysqli_fetch_assoc($result)) {
    ...
    $nazev = $row['nazev'];
        ...
        echo '
     <img class="card-img-top" src="polozky/'.$obrazek.'" alt="'.$nazev.'">
              ';
              echo ' '.$nazev.'';
           
             
          echo '    <span style=" color: green ;"  class="fa-sm"> Skladem > '.$kusu.' ks</span></h5>';
             echo '      <p class="card-text"> '.$popis.' -TOP PRODUKT</p>';
             echo '   <h5><span style=" color: red ;"  class="fa-sm">'.$cena.' Kč</span>' ;
            echo '      </div>
              <div class="card-footer">
               <button  style=" color: white ; width: 100%; background-color:red; " class="fa fa-shopping-cart fa-sm" >Vložit do košíku</button>
              </div>
            </div>
          </div>
        ';
